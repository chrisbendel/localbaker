...
module Dashboard
  class ProfilesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "update rejects bio longer than 1000 characters" do
      long_bio = "a" * 1001
      patch dashboard_profile_path, params: {store: {bio: long_bio}}
      assert_response :unprocessable_entity
    ...
    test "update accepts bio with maximum length" do
      max_bio = "a" * 1000
      patch dashboard_profile_path, params: {store: {bio: max_bio}}
      assert_redirected_to dashboard_profile_path
    ...
    test "update accepts instagram handle with leading @" do
      patch dashboard_profile_path, params: {store: {instagram_handle: "@mybakery"}}
      assert_redirected_to dashboard_profile_path
      assert_equal "@mybakery", @store.reload.instagram_handle
    end

    test "update accepts instagram handle with dots" do
      patch dashboard_profile_path, params: {store: {instagram_handle: "my.bakery.co"}}
      assert_redirected_to dashboard_profile_path
    ...
    test "update handles photo upload" do
      ...
      patch dashboard_profile_path, params: {store: {photo: photo}}
      assert_redirected_to dashboard_profile_path
    ...
    test "update handles photo removal" do
      ...
      patch dashboard_profile_path, params: {store: {remove_photo: "1"}}
      assert_redirected_to dashboard_profile_path
    end
  end
end
