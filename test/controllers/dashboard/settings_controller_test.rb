...
module Dashboard
  class DashboardControllerTest < ActionDispatch::IntegrationTest
    ...
    test "update updates store" do
      patch dashboard_settings_path, params: {store: {name: "Updated"}}
      assert_redirected_to dashboard_settings_path
      assert_equal "Updated", @store.reload.name
    end

    test "update handles address" do
      patch dashboard_settings_path, params: {store: {address: "456 Oven Rd, Portland, OR"}}
      assert_redirected_to dashboard_settings_path
    ...
    test "update handles banner removal" do
      ...
      patch dashboard_settings_path, params: {store: {remove_banner_image: "1"}}
      assert_redirected_to dashboard_settings_path
    ...
    test "update prevents slug change when store has active orders" do
      ...
      patch dashboard_settings_path, params: {store: {slug: "new-slug"}}
