...
module Stores
  class PaymentsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "show handles render" do
      get store_payments_path
      assert_response :success
    end

    test "update handles venmo" do
      patch store_payments_path, params: {store: {venmo_handle: "@newhandle"}}
      assert_redirected_to store_payments_path
      assert_equal "@newhandle", @store.reload.venmo_handle
    end

    test "update handles paypal" do
      patch store_payments_path, params: {store: {paypal_url: "https://paypal.me/new"}}
      assert_redirected_to store_payments_path
      assert_equal "https://paypal.me/new", @store.reload.paypal_url
    end

    test "update rejects invalid venmo handle" do
      patch store_payments_path, params: {store: {venmo_handle: "my.invalid"}}
      assert_response :unprocessable_entity
      refute_equal "my.invalid", @store.reload.venmo_handle
    end

    test "update rejects invalid paypal URL" do
      patch store_payments_path, params: {store: {paypal_url: "not a valid url"}}
      assert_response :unprocessable_entity
    ...
    test "update accepts clearing venmo handle" do
      ...
      patch store_payments_path, params: {store: {venmo_handle: ""}}
      assert_redirected_to store_payments_path
