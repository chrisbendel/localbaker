...
module Shop
  class OrderItemsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should require authentication" do
      post shop_event_order_items_url(@store.slug, @event), params: {event_product_id: @product.id}
    ...
    test "should destroy item directly" do
      ...
      assert_difference("OrderItem.count", -1) do
        delete shop_order_item_url(@store.slug, item)
      end
    ...
    test "should block adding to order for draft event" do
      ...
      assert_no_difference("OrderItem.count") do
        post shop_event_order_items_url(@store.slug, draft_event), params: {event_product_id: draft_product.id}
      end

      assert_redirected_to shop_event_path(@store.slug, draft_event)
